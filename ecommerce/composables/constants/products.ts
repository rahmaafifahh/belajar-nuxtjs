export const products = [
    ...
    {
      id: 2,
      name: "shoe sizes ranging from 30-70",
      category: "Sepatu",
      price: 20,
    ...
    {
      id: 6,
      name: "Kemeja hitam kotak-kotak garis putih",
      category: "Baju",
      price: 35,
    ...
    {
      id: 7,
      name: "Casual Long Sleeve Plaid Shirt - ",
      category: "Sepatu",
      price: 50,
